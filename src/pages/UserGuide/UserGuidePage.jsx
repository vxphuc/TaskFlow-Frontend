...
const guides = [
  ...
  },
  {
    ...
    audience: 'Dành cho người giao hoặc người thực hiện task chính',
    ...
    steps: [
      ...
      ['Tạo công việc con', 'Bấm Tạo subtask, chọn bộ phận, người thực hiện, người duyệt, ưu tiên và deadline. Có thể chọn cấp dưới ở phòng ban khác.'],
      ...
      ['Theo dõi tiến độ', 'Xem tại tab Công việc con hoặc phần Subtask tôi giao; danh sách tổng được chia 10 công việc mỗi trang.'],
      ['Chỉnh sửa subtask', 'Người tạo subtask có thể sửa tiêu đề, mô tả, ưu tiên và deadline khi công việc đang ở trạng thái cho phép.'],
